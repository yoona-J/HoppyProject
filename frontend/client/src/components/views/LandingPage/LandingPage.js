    ...
    return (
        <div
            ...
            <div
                ...
                <a href='/exerciseMeeting' style={{textDecoration: 'none', color: '#000'}}>
                ...
                <a href='/musicMeeting' style={{textDecoration: 'none', color: '#000'}}>
                    <div style={hobbyBoxStyle}>
                        음악
                        <img src={MusicImg} style={hobbyImageStyle}/>
                    </div>
                </a>
                <a href='/dailyMeeting' style={{textDecoration: 'none', color: '#000'}}>
                    <div style={hobbyBoxStyle}>
                        일상
                        <img src={DailyImg} style={hobbyImageStyle}/>
                    </div>
                </a>
                <a href='/foodMeeting' style={{textDecoration: 'none', color: '#000'}}>
                    <div style={hobbyBoxStyle}>
                        음식
                        <img src={FoodImg} style={hobbyImageStyle}/>
                    </div>
                </a>
                <a href='/tripMeeting' style={{textDecoration: 'none', color: '#000'}}>
                    <div style={hobbyBoxStyle}>
                        여행
